...
export default function AyudaEleccionCotizaciones({
    mostrar = true,
    titulo = "¿No estás seguro cuál elegir?",
    descripcion = "Nuestro equipo puede ayudarte a tomar la mejor decisión para tu evento",
    telefonoWhatsApp = "5544546582", // Teléfono por defecto, debe venir de la BD
    telefonoLlamada = "5544546582", // Teléfono por defecto, debe venir de la BD
    ...
    return (
        <div className={`mt-10 lg:mt-12 text-center ${className}`}>
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6 lg:p-8 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <a
                        href={`https://wa.me/${telefonoWhatsApp}?text=${encodeURIComponent(mensajeWhatsApp)}`}
                        target="_blank"
