...
export default function AgendaOptimizada({ eventoId }: Props) {
                                ...
                                <div className=''>
                                    <div>
                                        ...
                                        <div className='flex items-center mb-2 justify-between w-full'>
                                            <div
                                                className={`text-zinc-400 mr-2 text-xs border px-2 py-1 rounded-md inline-block mb-2 ${agenda.agendaTipo === 'Evento'
                                                    ? 'border-pink-500 text-pink-300'
                                                    : agenda.agendaTipo === 'Cita virtual'
                                            ...
                                            <div className='flex items-center'>
                                                <button
                                                    onClick={() => agenda.id && handleStatusAgendaActividad(
                                                        agenda.id,
                                                        agenda.status === 'pendiente' ? 'completado' : 'pendiente'
                                                    )}
                                                    className={`border rounded-md py-1 px-2 text-xs ${agenda.status === 'pendiente'
