    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                {/* Columna 2: Wishlist de Servicios */}
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {serviciosWishlist.length > 0 && (
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={() => setVistaWishlist('nested')}
                                        className={`px-2 py-1 text-xs rounded ${vistaWishlist === 'nested'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-zinc-700 text-zinc-300 hover:bg-zinc-600'
                                            }`}
                                    >
                                    ...
                                    <button
                                        onClick={() => setVistaWishlist('tabla')}
                                        className={`px-2 py-1 text-xs rounded ${vistaWishlist === 'tabla'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-zinc-700 text-zinc-300 hover:bg-zinc-600'
                                            }`}
                                    >
                ...
                {/* Columna 3: Catálogo y Simulador */}
