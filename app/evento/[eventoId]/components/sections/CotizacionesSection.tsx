...
export default function CotizacionesSection({ cotizaciones, eventoId }: Props) {
                        ...
                        <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6 max-w-2xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium py-2.5 px-5 rounded-lg transition-colors text-sm"
                                >
                                ...
                                <a
                                    href="tel:5544546582"
                                    className="inline-flex items-center justify-center gap-2 bg-zinc-700 hover:bg-zinc-600 text-white font-medium py-2.5 px-5 rounded-lg transition-colors text-sm"
                                >
