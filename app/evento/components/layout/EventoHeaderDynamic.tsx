...
export default function EventoHeader({
    ...
    // URL por defecto si no se proporciona logotipo
    const logoUrl = logotipo || 'https://bgtapcutchryzhzooony.supabase.co/storage/v1/object/public/ProSocial/logos/logotipo_blanco.svg'
                    ...
                    <div className="flex items-center">
                        <Image
                            ...
                            onError={(e) => {
                                ...
                                target.src = 'https://bgtapcutchryzhzooony.supabase.co/storage/v1/object/public/ProSocial/logos/logotipo_blanco.svg'
                            }}
                        />
                    </div>
