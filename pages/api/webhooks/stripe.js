        ...
        await prisma.notificacion.create({
          data: {
            ...
            metadata: {
              ...
              rutaDestino: `/admin/dashboard/seguimiento/${evento.id}`,
              accionBitacora: {
                habilitada: true,
                mensaje: `Pago confirmado: ${pagoActualizado.monto.toLocaleString("es-MX", { style: "currency", currency: "MXN" })} - Stripe`,
              },
            },
            status: "active",
            createdAt: new Date(),
