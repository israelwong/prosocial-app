...
function migrarEventoStatus(legacyStatus) {
  return (
    EVENTO_STATUS_MIGRATION_MAP[legacyStatus.toLowerCase()] ||
...
function migrarCotizacionStatus(legacyStatus) {
  return (
    COTIZACION_STATUS_MIGRATION_MAP[legacyStatus.toLowerCase()] ||
...
function migrarPagoStatus(legacyStatus) {
  return (
    PAGO_STATUS_MIGRATION_MAP[legacyStatus.toLowerCase()] || PAGO_STATUS.PENDING
  );
}
